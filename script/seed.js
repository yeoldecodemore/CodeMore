...
async function seed() {
  ...
  const problems = await Promise.all([
    Problem.create({
      ...
      problemDescription:
        'Create an array which contains the values 1 through n, backwards.',
      problemExample: 'Example: backwardsArray(4) returns [4,3,2,1]',
    ...
    Problem.create({
      ...
      problemDescription:
        'Return the number of vowels that are within a string.',
      problemExample: 'Example: countVowels("Learning code is fun") returns 7',
    ...
    Problem.create({
      ...
      problemDescription: 'Return true or false if the string is a Palindrome.',
      problemExample: ' Example: isPalindrome("dad") returns true',
    ...
    Problem.create({
      ...
      problemDescription:
        'Given a string, replace every letter with its position in the alphabet. If anything in the text is not a letter, ignore it and do not return it. ',
      problemExample:
        'Example: alphabetPosition("The sunset sets at twelve") returns "20 8 5 19 21 14 19 5 20 19 5 20 19 1 20 20 23 5 12 22 5" ',
    ...
    Problem.create({
      ...
      problemDescription:
        'Write a function that takes a non-empty array of distinct integers and an integer representing a target sum. If any two numbers in the input array sum to the target sum, the function should return them in an array in sorted order. ',
      problemExample: 'Example twoNumberSum([4,6], 10) returns [4,6]',
    ...
    Problem.create({
      ...
      problemExample: 'Example: maxSubsetSumNoAdjacent([1,15,3]) returns 15',
    ...
    Problem.create({
      ...
      problemDescription:
        'Given a non-empty array of integers with each element representing the maximum number of steps you can take forward, write a function that returns the minimum number of jumps needed to reach the final index. ',
      problemExample: 'Example: minNumberOfJumps([2,1,2,2,1,1,1]) returns 4',
    ...
    Problem.create({
      ...
      problemDescription:
        'You are given an array of integers. Each non-zero integer represents the height of a pillar with width 1. Imagine water being poured over all of the pillars and return the surface area of the water trapped between the pillars viewed from the front. Spilled water should be ignored. ',
      problemExample:
        'Example: waterArea([0,8,0,0,5,0,0,10,0,0,1,1,0,3]) returns 48',
    ...
    Problem.create({
      ...
      problemExample: 'Example: nthFib(6) returns 5',
